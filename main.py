...
alienvault_logger = logging.getLogger(__name__)
...
pulse_output_file = os.path.join(output_folder, 'pulse_output.csv')
otx_indicators_and_types = os.path.join(output_folder, 'otx_indicators_and_types.csv')
...
class alienvault_otx():
    ...
    def otx_retrieve_all_pulses(self):
        try:
            ...
            granular_otx_df.to_csv(otx_indicators_and_types, index=False,quoting=csv.QUOTE_NONNUMERIC)
...
if __name__ == '__main__':
    try:
        ...
        # their pulses.
        alienvault_otx(otx_api='9f7c2e6d048af5a2bfc74a364b00f81f117ecf506358f3ec844dd777954081cf',
                       days_to_go_back=7)
        end = time.time()
        alienvault_logger.info(f'\n')
        ...
        # Python Error Code
        alienvault_logger.error(f'The code failed. The error is {e}.')
